...
- [RustChain](https://github.com/Scottcjn/RustChain) - Proof-of-Antiquity blockchain built in Rust where vintage hardware earns higher mining rewards via GPU hardware attestation. Ed25519 consensus. [rustchain.org](https://rustchain.org/)
